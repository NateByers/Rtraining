...
data. This tutorial will give a brief introduction to many of the plotting functions
...
We'll be using the `chicago_air` data frame, which already has a date column.
...
We need to change it using the `as.POSIXct()` function.
