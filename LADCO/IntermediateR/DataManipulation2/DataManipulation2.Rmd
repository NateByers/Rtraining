---
title: 'Data Manipulation: dplyr and tidyr'
...
In the first Data Manipulation tutorial we learned how to use the `group_by()` and
`summarise()` functions to aggregate data. Those functions are useful in situations
where you need to summarise data based on other columns, such as daily summaries 
for each site and pollutant in a data set. 
...
and the third column specifies which columns will be gathered.
