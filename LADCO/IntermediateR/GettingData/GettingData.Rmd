...
- [Querying a database using SQL from R](#query)
...
<a href= "https://github.com/FluentData/raqdm" target="_blank">GitHub</a>. It utilizes
U.S. EPA's <a href="https://aqs.epa.gov/api" target="_blank">AirData API</a>. To 
use EPA's AirData you must register for an account. Once
...
(usually just 1 or 2 minutes) you can run the `getAQDMrequest()` function
...
Disconnect from the database and delete the database from your working directory.
