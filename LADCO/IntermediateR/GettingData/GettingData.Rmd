...
That is how you make a connection to an SQLite database. If the database doesn't
exist already it will create one.
...
Now we'll disconnect from the database and delete the database.
...
- Exercises for this tutorial are found here.
- Solutions to the exercises are found here.
...
downloads the Nonpoint file to a temporary file, unzips it to your working directory,
reads the file into R, and deletes the files on your machine.
...
download.file("ftp://ftp.epa.gov/EmisInventory/2011/2011neiv2_nonpoint.zip", temp)
...
# read the data into R--this will take a while
data <- read.csv("2011v2_nonpoint.csv", stringsAsFactors = FALSE)

# delete the file in your working directory
unlink("2011v2_nonpoint.csv")
...
### Querying a database using SQL from R
...
of querying an SQLite databse in R.
...
Disconnect from the datbase and delete the database from your working directory.
